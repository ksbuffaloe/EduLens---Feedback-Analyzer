...
def chatGPT_cluster_labels(features, feedback):
    ...
    response = openai.chat.completions.create(
        ...
        messages=[
            {"role": "user", "content": f"Given a list of top features and feedback from students for a cluster analysis, create a cluster name, pay special attention to the feedback. \nFeatures: \n{features}\n Feedback: \n {feedback}"}
        ]
    )
